<template>
  <Loading-page>
    <div class="_layout">
      ...
      <table-box @reset="initPage" :list-data ='bbsTopicList' />
...
export default class Qasons extends Vue {
  ...
  @Action('getBbsTopicList') private getBbsTopicList!: (params: object) => Promise<any>
  @Getter private bbsTopicList!: []
  @Getter private bbsTopicListCount!: number
  ...
  public handleSizeChange(val: number) {
    this.pageSize = val
    this.getBbsTopicList(this.searchParams)
  }
  ...
  public handleSearch(obj: object) {
    this.getBbsTopicList({...this.searchParams, ...obj})
  }
